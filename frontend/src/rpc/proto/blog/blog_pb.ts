...
// @generated from file proto/blog/blog.proto (package post, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message post.Post
 */
export class Post extends Message<Post> {
  ...
  static readonly typeName = "post.Post";
...
/**
 * @generated from message post.Posts
 */
export class Posts extends Message<Posts> {
  /**
   * @generated from field: repeated post.Post posts = 1;
   */
  posts: Post[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "post.Posts";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message post.CreatePostRequest
 */
export class CreatePostRequest extends Message<CreatePostRequest> {
  /**
   * @generated from field: post.Post post = 1;
   */
  post?: Post;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "post.CreatePostRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message post.CreatePostResponse
 */
export class CreatePostResponse extends Message<CreatePostResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "post.CreatePostResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "post", kind: "message", T: Post },
  ]);
...
/**
 * @generated from message post.GetPostsResponse
 */
export class GetPostsResponse extends Message<GetPostsResponse> {
  /**
   * @generated from field: post.Posts posts = 1;
   */
  posts?: Posts;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "post.GetPostsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message post.GetPostsRequest
 */
export class GetPostsRequest extends Message<GetPostsRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "post.GetPostsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "posts", kind: "message", T: Posts },
  ]);
